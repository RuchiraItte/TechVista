    ...
    <div>
      ...
      <Router>
        <Routes>
          ...
          <Route
            path="/event/hackathon/register"
            element={<HackathonRegistration />}
          />
          <Route path="/event/bgmi/register" element={<BgmiRegister />} />
          <Route
            path="/event/blind_coding/register"
            element={<BlindCodingRegister />}
          />
          <Route
            path="/event/bug_bounty/register"
            element={<BugBountyRegister />}
          />
          <Route
            path="/event/code_hunt/register"
            element={<CodeHuntRegister />}
          />
          <Route path="/event/m2m/register" element={<MTwoMRegister />} />

          <Route path="/event/prompt/register" element={<PromptRegister />} />
          <Route
            path="/event/research/register"
            element={<ResearchRegister />}
          />
          <Route path="/event/standup/register" element={<StandupRegister />} />
          <Route
            path="/event/track_race/register"
            element={<TrackRaceRegister />}
          />
          <Route
            path="/event/treasure_hunt/register"
            element={<TreasureHuntRegister />}
          />
          <Route path="/event/uiux/register" element={<UiuxRegister />} />
          <Route
            path="/event/valorant/register"
            element={<ValorantRegister />}
          />
